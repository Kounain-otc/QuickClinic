...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      <img onClick={()=>navigate('/')} className="h-12 md:h-14 w-auto cursor-pointer object-contain" src={assets.logo2} alt="" />
      <ul className="hidden md:flex itemss-start gap-5 font-medium">
        <NavLink to='/'>
      ...
      <div className="flex items-center gap-4">
        {
          ...
          ? <div className="flex items-center gap-2 cursor-pointer group relative">
            <img className="w-4 rounded-md" src={assets.profile} alt="" />
